...
TEST_SUITE("lfilter") {
  ...
  TEST_CASE("3rdOrderButterworth") {
    ...
    // define the signal
    xt::xtensor<float, 1> sig = {-0.917843918645, 0.141984778794,  1.20536903482,  0.190286794412, -0.662370894973,
    ...
    xt::xtensor<float, 1> expectation = {-0.152974,  -0.435258, -0.136043, 0.697503,  0.656445, -0.435483, -1.08924,
                                         -0.537677,  0.51705,   1.05225,   0.961854,  0.69569,  0.424356,  0.196262,
                                         -0.0278351, -0.211722, -0.174746, 0.0692584, 0.385446, 0.651771};
...
TEST_CASE("3rdOrderButterworth_MultipleDims") {
    ...
    xt::xarray<float> sig2 = xt::stack(std::make_tuple(sig, xt::zeros_like(sig)), 1);
